...
const MOCK_CATALOGUE: IgotCourse[] = [
  ...
  {
    externalId: "nssta_tpac_2026_PY01",
    title: "Python for Statistical Analysis (TPAC-recommended)",
    description:
      "NSSTA Training Priority and Advisory Committee recommended programme. pandas, numpy and statsmodels applied to survey data, with survey-weighted estimation and reproducible pipelines. Worked examples use PLFS and HCES microdata.",
    provider: "NSSTA · TPAC-recommended",
    thumbnailUrl: null,
    contentUrl: "https://www.mospi.gov.in/nssta/training",
    durationMinutes: 720, language: "en", difficulty: "practitioner",
    rating: 4.7, enrolledCount: 3120,
    competencyCodes: ["TEC-PY-01", "TEC-SQL-01", "FUN-TOOL-01"],
    raw: { source: "NSSTA", tpac_recommended: true, cycle: "2026" },
  },
  {
    externalId: "nssta_tpac_2026_GIS01",
    title: "GIS for Statistical Applications (TPAC-recommended)",
    description:
      "NSSTA TPAC programme on geospatial methods for official statistics: boundary files, spatial joins, area-weighted apportionment and small-area estimation for district-level indicators.",
    provider: "NSSTA · TPAC-recommended",
    thumbnailUrl: null,
    contentUrl: "https://www.mospi.gov.in/nssta/training",
    durationMinutes: 480, language: "en", difficulty: "practitioner",
    rating: 4.5, enrolledCount: 2890,
    competencyCodes: ["TEC-GIS-01", "DOM-AGRI-01"],
    raw: { source: "NSSTA", tpac_recommended: true, cycle: "2026" },
  },
  {
    externalId: "nssta_tpac_2026_ML01",
    title: "Machine Learning in Official Statistics (TPAC-recommended)",
    description:
      "Where ML genuinely improves official statistics and where it must not be used: automatic NIC/NCO coding, imputation, nowcasting — and the explainability bar an official release has to clear.",
    provider: "NSSTA · TPAC-recommended",
    thumbnailUrl: null,
    contentUrl: "https://www.mospi.gov.in/nssta/training",
    durationMinutes: 600, language: "en", difficulty: "proficient",
    rating: 4.6, enrolledCount: 2410,
    competencyCodes: ["TEC-ML-01", "TEC-PY-01", "FUN-ANAL-01"],
    raw: { source: "NSSTA", tpac_recommended: true, cycle: "2026" },
  },
  {
    externalId: "igot_dpdp_2026_01",
    title: "DPDP Act 2023 Compliance for Statistical Work",
    description:
      "Applying the Digital Personal Data Protection Act alongside the Collection of Statistics Act: purpose limitation, data minimisation, consent, and conducting a data protection impact assessment for a new collection.",
    provider: "MoSPI", thumbnailUrl: null,
    contentUrl: "https://igotkarmayogi.gov.in/course/igot_dpdp_2026_01",
    durationMinutes: 300, language: "en", difficulty: "practitioner",
    rating: 4.6, enrolledCount: 3402,
    competencyCodes: ["DIG-PRIV-01", "FUN-CONF-01"],
    raw: {},
  },
  {
    externalId: "igot_sql_2026_01",
    title: "SQL for Data Management in Government",
    description:
      "Query, join and aggregate relational data without depending on someone else to extract it. Window functions, CTEs and query cost on large statistical tables.",
    provider: "Karmayogi Bharat", thumbnailUrl: null,
    contentUrl: "https://igotkarmayogi.gov.in/course/igot_sql_2026_01",
    durationMinutes: 360, language: "en", difficulty: "practitioner",
    rating: 4.4, enrolledCount: 2650,
    competencyCodes: ["TEC-SQL-01", "TEC-VIZ-01"],
    raw: {},
  },
  {
    externalId: "igot_cyber_2026_01",
    title: "Cybersecurity Essentials for Government Officials",
    description:
      "Phishing, credential hygiene, secure microdata transfer and access control — the practical security posture required when handling citizen data.",
    provider: "Karmayogi Bharat", thumbnailUrl: null,
    contentUrl: "https://igotkarmayogi.gov.in/course/igot_cyber_2026_01",
    durationMinutes: 180, language: "en", difficulty: "beginner",
    rating: 4.3, enrolledCount: 1980,
    competencyCodes: ["DIG-CYBER-01", "TEC-CLOUD-01"],
    raw: {},
  },
  {
