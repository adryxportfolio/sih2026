# Contributing to Samiksha

Thanks for helping improve Samiksha. Keep changes focused and testable.
...
`apps/web/src/lib/i18n.ts`, then run `pnpm --filter @samiksha/web intl:extract`, fill the new
`apps/web/src/locales/<locale>/messages.po` catalog, and validate it with
`pnpm --filter @samiksha/web intl:compile`. Keep message IDs, placeholders, JSX markers, and
...
| Address | Use for |
| --- | --- |
| [security@samiksha.com](mailto:security@samiksha.com) | Vulnerabilities only — see [SECURITY.md](SECURITY.md) |
| [support@samiksha.com](mailto:support@samiksha.com) | User and support questions |
| [elie@samiksha.com](mailto:elie@samiksha.com) | Maintainer |
