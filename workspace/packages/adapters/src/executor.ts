...
import type { MessageBlock, RunStatus } from "@samiksha/contracts";
import {
...
const STATIC_SHELL_EXPANSIONS: Readonly<Record<string, string>> = {
  ...
  TMPDIR: "/tmp",
  USER: "samiksha",
  WORKSPACE: "/home/samiksha/workspace",
  XDG_CONFIG_HOME: "/home/samiksha/.config",
};
...
const CATALOG_APPROVAL_TOOL = "__samikshaCatalogTool";
...
export function buildApprovalContinuation(
  ...
  return [
    "Samiksha is resuming after the user approved the exact tool request(s) below.",
