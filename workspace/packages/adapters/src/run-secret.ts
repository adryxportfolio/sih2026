import type { AdapterContext, ManagedConnectorProvider } from "@samiksha/adapter-kit";
import { SecretAskPurpose } from "@samiksha/contracts";
import type { PrismaClient, RunSecretWriter } from "@samiksha/db";
