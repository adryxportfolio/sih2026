...
import type { ModelConnectInput, ModelCredential, ThinkingLevel } from "@samiksha/contracts";
import { OPENAI_COMPATIBLE_PROVIDER_ID as CONTRACT_OPENAI_COMPAT } from "@samiksha/contracts";
