import type { TransactionalEmail } from "@samiksha/adapter-kit";
import { bootstrapUserSpace } from "@samiksha/db";
...
vi.mock("@samiksha/db", () => ({ bootstrapUserSpace: vi.fn(async () => ({ spaceId: "space-1" })) }));
