...
<head>
  ...
  <title>Playwright · Samiksha</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Samiksha · browser checks</p>
        <h1>Playwright</h1>
      ...
      <div class="actions">
        ...
        <a class="button" href="https://github.com/elie222/samiksha/actions">GitHub Actions</a>
      </div>
    </header>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="dark" />
  <title>${mobile ? "Android screenshots" : "Run screenshots"} · Samiksha</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Samiksha · visual review</p>
  ...
  <script>
    ...
    const storageKey = "samiksha-playwright-gallery-columns";
