 ...
 */
export const PUBLISHED_IMAGE_REPO = "elie222/samiksha";
...
export const IMAGE_TAG_ENV = "SAMIKSHA_IMAGE_TAG";
export const PREVIOUS_IMAGE_TAG_ENV = "SAMIKSHA_IMAGE_TAG_PREVIOUS";
 ...
 */
export const DEFAULT_COMPOSE_PROJECT_NAME = "samiksha-prod";
export const COMPOSE_PROJECT_NAME_ENV = "COMPOSE_PROJECT_NAME";
export const COMPOSE_PROJECT_NAME_OVERRIDE_ENV = "SAMIKSHA_COMPOSE_PROJECT_NAME";
 ...
 * absent because neither uses the Samiksha image.
 */
...
/**
 * `updaterUrlConfigured` means the API was given `SAMIKSHA_UPDATER_URL` (Compose prod always sets
...
export const SOURCE_MANUAL_UPGRADE_COMMANDS = [
  "git pull",
  "pnpm --filter @samiksha/db migrate",
