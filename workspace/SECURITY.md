...
Email **security@samiksha.com** only. Do not open public GitHub issues for security bugs.
...
- General support: **support@samiksha.com**
- Maintainer: **elie@samiksha.com**

## Scope

This policy covers the Samiksha self-hosted product in **this repository**.
