import type { ModelOAuthBegin } from "@samiksha/contracts";
import { cancelModelOAuthAttempt, finishModelOAuthAttempt } from "@samiksha/core";
  ...
  async function startSubscriptionSignIn(begin: ModelOAuthSignInBegin) {
    ...
    try {
      ...
      if (browserAuth?.open) {
        ...
        window.open(started.verificationUri, "samiksha-model-oauth", "noopener,noreferrer");
      }
