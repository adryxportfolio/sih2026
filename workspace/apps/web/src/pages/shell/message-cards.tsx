...
import { Button, Dialog, DialogClose, DialogContent, DialogTitle } from "@samiksha/ui-web";
  ...
  async function authorize() {
    ...
    try {
      ...
      if (started.authorizationUrl) {
        window.open(started.authorizationUrl, "samiksha-app-connect", "popup,width=560,height=720");
      }
...
function ChartCanvas({
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        const { buildPlotParts } = await import("@samiksha/core/plot");
