...
import { COMPUTER_SCREEN_UNAVAILABLE, ComputerScreenUnavailableError } from "@samiksha/adapters";
import type { Actor } from "@samiksha/contracts";
import { openScreenCapability } from "@samiksha/core/node/screen-capability";
...
describe("account preferences", () => {
  function preferencesDeps(avatarStyle: string) {
    ...
    const deps = {
      ...
      dataDir: "/tmp/samiksha-router-test",
