import type { JobPublisher, MessagingInboundMessage } from "@samiksha/adapter-kit";
import { messagingDeliverJob, runContinueJob } from "@samiksha/adapter-kit";
import type { MessageBlock } from "@samiksha/contracts";
import { parseMessagingCommand, sanitizeMessagingLabel } from "@samiksha/core";
import type {
      ...
      data: [
        {
          ...
          body: "Hi. This line hosts Samiksha personal agents. Some people in this group haven't messaged it yet; send any message to this line first if you want your own agent here.",
        },
      ],
      skipDuplicates: true,
    });
    ...
    data: [
      {
        ...
        body: `"${name}" was linked to your Samiksha agent. Reply YES to let your agent join the conversation there, or NO to stay out.`,
      },
    ],
    skipDuplicates: true,
  });
