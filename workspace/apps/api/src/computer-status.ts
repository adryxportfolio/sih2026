import { computerSupportsUpdate } from "@samiksha/adapters";
import type { ComputerStatus } from "@samiksha/contracts";
import { ACTIVE_RUN_STATUSES, computerScreenSize } from "@samiksha/core";
