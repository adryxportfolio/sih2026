...
import { hasActiveComputerControl } from "@samiksha/adapters";
import type { ScreenCapabilityScope } from "@samiksha/core/node/screen-capability";
import {
  openScreenCapability,
  SCREEN_TARGET_ENDPOINT,
  sealScreenCapability,
} from "@samiksha/core/node/screen-capability";
